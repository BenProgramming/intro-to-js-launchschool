...
// take two arguments: the object to copy and an array of the keys that you 
...
const copyObj = (obj, arrKeys) => {
	let retArr = {}; 

	console.log(typeof arrKeys);

	if (typeof arrKeys === "undefined") {
		return Object.assign(retArr, obj); 	
	} else {
		arrKeys.forEach(arrVal => retArr[arrVal] = obj[arrVal])
		return retArr;
	}
}
